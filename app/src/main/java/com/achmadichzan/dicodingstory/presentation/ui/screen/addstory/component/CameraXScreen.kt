...
fun CameraXScreen(
    ...
    var compressingProgress by remember { mutableFloatStateOf(0f) }
    ...
    Scaffold(
        ...
        Box(modifier = Modifier.fillMaxSize().padding(innerPadding)) {
            ...
            if (compressingProgress > 0f && compressingProgress < 100f) {
                CircularProgressIndicator(
                    progress = { compressingProgress / 100f },
                    modifier = Modifier
                        ...
                        imageCapture?.takePicture(
                            ...
                            object : ImageCapture.OnImageSavedCallback {
                                override fun onImageSaved(output: ImageCapture.OutputFileResults) {
                                    coroutineScope.launch {
                                        val compressedFile = FileUtil.compressImageFileWithProgress(
                                            context,
                                            photoFile,
                                            onProgress = { progress ->
